(function() {
          ...
          _v36_3: do {
            _v36_2: do {
              _v36_1: do {
                ...
                return _elm_lang$core$Dict$balancedTree(_p27._0)(_p27._3._3._1)(_p27._3._3._2)(_p27._3._1)(_p27._3._2)(
                  _p27._1
                )(_p27._2)(_p27._3._3._3)(_p27._3._3._4)(_p27._3._4)(_p27._4);
              } while (false);
              return _elm_lang$core$Dict$balancedTree(_p27._0)(_p27._3._1)(_p27._3._2)(_p27._3._4._1)(_p27._3._4._2)(
                _p27._1
              )(_p27._2)(_p27._3._3)(_p27._3._4._3)(_p27._3._4._4)(_p27._4);
            } while (false);
            return _elm_lang$core$Dict$balancedTree(_p27._0)(_p27._1)(_p27._2)(_p27._4._3._1)(_p27._4._3._2)(
              _p27._4._1
            )(_p27._4._2)(_p27._3)(_p27._4._3._3)(_p27._4._3._4)(_p27._4._4);
          } while (false);
          return _elm_lang$core$Dict$balancedTree(_p27._0)(_p27._1)(_p27._2)(_p27._4._1)(_p27._4._2)(_p27._4._4._1)(
            _p27._4._4._2
          )(_p27._3)(_p27._4._3)(_p27._4._4._3)(_p27._4._4._4);
        } while (false);
        return A5(
          _elm_lang$core$Dict$RBNode_elm_builtin,
      ...
      switch (decoder.tag) {
        ...
        case "index":
          ...
          if (index >= value.length) {
            return badPrimitive(
              "a longer array. Need index " + index + " but there are only " + value.length + " entries",
              value
            );
          }
  ...
  var _user$project$Main$wilksCoeffWithCoeffs = F7(function(a, b, c, d, e, f, bodyweight) {
    var x = bodyweight;
    return 500 / (a + b * x + c * Math.pow(x, 2) + d * Math.pow(x, 3) + e * Math.pow(x, 4) + f * Math.pow(x, 5));
  });
  var _user$project$Main$femaleWilksCoeffKg = function(bodyweight) {
    var f = -9.054e-8;
    var e = 4.731582e-5;
    var d = -9.30733913e-3;
    var c = 0.82112226871;
    ...
    return A7(_user$project$Main$wilksCoeffWithCoeffs, a, b, c, d, e, f, bodyweight);
  };
  var _user$project$Main$maleWilksCoeffKg = function(bodyweight) {
    var f = -1.291e-8;
    var e = 7.01863e-6;
    var d = -1.13732e-3;
    var c = -2.388645e-3;
  ...
  var _user$project$Main$wilksCoeffKg = F2(function(gender, bodyweight) {
    var _p0 = gender;
    if (_p0.ctor === "Male") {
      return _user$project$Main$maleWilksCoeffKg(bodyweight);
    } else {
      return _user$project$Main$femaleWilksCoeffKg(bodyweight);
    }
  });
  var _user$project$Main$wilksScoreKg = F3(function(gender, bodyweight, weight) {
    return A2(_user$project$Main$wilksCoeffKg, gender, bodyweight) * weight;
  });
  var _user$project$Main$fieldNameStyle = function(px) {
  ...
  var _user$project$Main$stringToAction = F2(function(toAction, string) {
    var _p1 = _elm_lang$core$String$toFloat(string);
    if (_p1.ctor === "Ok") {
      var _p2 = _p1._0;
      return A2(_elm_lang$core$String$endsWith, ".", string)
        ? A2(toAction, _elm_lang$core$Maybe$Just(_p2), string)
        : A2(toAction, _elm_lang$core$Maybe$Just(_p2), _elm_lang$core$Basics$toString(_p2));
    } else {
      return A2(toAction, _elm_lang$core$Maybe$Nothing, string);
    }
  });
  var _user$project$Main$onChangeUnit = function(toAction) {
    return A2(
      _elm_lang$html$Html_Events$on,
      "change",
      A2(_elm_lang$core$Json_Decode$map, toAction, _elm_lang$html$Html_Events$targetValue)
    );
  };
  var _user$project$Main$removeSpace = _elm_lang$core$String$filter(function($char) {
    return !_elm_lang$core$Native_Utils.eq($char, _elm_lang$core$Native_Utils.chr(" "));
  });
  var _user$project$Main$selectDiv = F3(function(onChange, name, options) {
    return A2(
      ...
      { ctor: "[]" },
      {
        ...
        _0: A2(
          ...
          {
            ctor: "::",
            _0: _user$project$Main$fieldNameStyle("160px"),
            _1: { ctor: "[]" },
          },
          {
            ctor: "::",
            _0: A2(
              ...
              {
                ctor: "::",
                _0: A2(_elm_lang$html$Html_Attributes$attribute, "for", _user$project$Main$removeSpace(name)),
                _1: { ctor: "[]" },
              },
              {
                ctor: "::",
        ...
        _1: {
          ...
          _0: A2(
            ...
            {
              ctor: "::",
              _0: A2(_elm_lang$html$Html_Attributes$attribute, "name", _user$project$Main$removeSpace(name)),
              _1: {
                ctor: "::",
                _0: onChange,
                _1: { ctor: "[]" },
  ...
  var _user$project$Main$field = F4(function(fieldType, toAction, name, content) {
    return A2(
      _elm_lang$html$Html$div,
      { ctor: "[]" },
      {
        ...
        _1: {
          ...
          _0: A2(
            ...
            {
              ctor: "::",
              _0: _elm_lang$html$Html_Attributes$type_(fieldType),
              _1: {
                ctor: "::",
                  ...
                  _1: {
                    ...
                    _1: {
                      ...
                      _0: A2(
                        ...
                        A2(
                          _elm_lang$core$Json_Decode$map,
                          _user$project$Main$stringToAction(toAction),
  ...
  var _user$project$Main$update = F2(function(action, model) {
    var _p3 = action;
    switch (_p3.ctor) {
      case "UpdateGender":
        return _elm_lang$core$Native_Utils.update(model, { gender: _p3._0 });
      case "UpdateBodyweightUnits":
        return _elm_lang$core$Native_Utils.update(model, { bodyweightUnits: _p3._0 });
      case "UpdateBodyweight":
        return _elm_lang$core$Native_Utils.update(model, { bodyweight: _p3._0, partialBodyweight: _p3._1 });
      case "UpdateWeightUnits":
        return _elm_lang$core$Native_Utils.update(model, { weightUnits: _p3._0 });
      case "UpdateWeight":
        return _elm_lang$core$Native_Utils.update(model, { weight: _p3._0, partialWeight: _p3._1 });
      default:
        return model;
    }
  });
  var _user$project$Main$Model = F7(function(a, b, c, d, e, f, g) {
    return {
      gender: a,
      partialBodyweight: b,
      bodyweightUnits: c,
  ...
  var _user$project$Main$toGender = function(gender) {
    var _p4 = gender;
    switch (_p4) {
      case "Male":
        return _user$project$Main$Male;
      case "Female":
        return _user$project$Main$Female;
      default:
        return _user$project$Main$Female;
    }
  };
  var _user$project$Main$Lbs = { ctor: "Lbs" };
  var _user$project$Main$initModel = {
    gender: _user$project$Main$Male,
    bodyweightUnits: _user$project$Main$Lbs,
    partialBodyweight: "",
    bodyweight: _elm_lang$core$Maybe$Nothing,
    weightUnits: _user$project$Main$Lbs,
    partialWeight: "",
    weight: _elm_lang$core$Maybe$Nothing,
  };
  var _user$project$Main$Kg = { ctor: "Kg" };
  var _user$project$Main$toUnits = function(unit) {
    var _p5 = unit;
    switch (_p5) {
      case "kg":
        return _user$project$Main$Kg;
      case "lbs":
        return _user$project$Main$Lbs;
      default:
        return _user$project$Main$Lbs;
    }
  };
  var _user$project$Main$NoOp = { ctor: "NoOp" };
  var _user$project$Main$UpdateWeight = F2(function(a, b) {
    return { ctor: "UpdateWeight", _0: a, _1: b };
  });
  var _user$project$Main$UpdateWeightUnits = function(a) {
    return { ctor: "UpdateWeightUnits", _0: a };
  };
  var _user$project$Main$UpdateBodyweight = F2(function(a, b) {
    return { ctor: "UpdateBodyweight", _0: a, _1: b };
  });
  var _user$project$Main$UpdateBodyweightUnits = function(a) {
    return { ctor: "UpdateBodyweightUnits", _0: a };
  };
  var _user$project$Main$UpdateGender = function(a) {
    return { ctor: "UpdateGender", _0: a };
  };
  var _user$project$Main$onChangeGender = (function() {
    var toAction = function(x) {
      return _user$project$Main$UpdateGender(_user$project$Main$toGender(x));
    };
    return A2(
      _elm_lang$html$Html_Events$on,
      "change",
  ...
  var _user$project$Main$view = function(model) {
    ...
    var bodyweight = _elm_lang$core$Native_Utils.eq(model.bodyweightUnits, _user$project$Main$Kg)
      ? model.bodyweight
      : A2(_elm_lang$core$Maybe$map, toKg, model.bodyweight);
    var weight = _elm_lang$core$Native_Utils.eq(model.weightUnits, _user$project$Main$Kg)
      ? model.weight
      : A2(_elm_lang$core$Maybe$map, toKg, model.weight);
    var maybeWilks = A3(_elm_lang$core$Maybe$map2, _user$project$Main$wilksScoreKg(model.gender), bodyweight, weight);
    var textWilks = A2(
      _elm_lang$core$Maybe$withDefault,
      "",
      A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, maybeWilks)
    );
    return A2(
      _elm_lang$html$Html$div,
      { ctor: "[]" },
      {
        ctor: "::",
        _0: A3(_user$project$Main$selectDiv, _user$project$Main$onChangeGender, "Gender", {
          ctor: "::",
          _0: "Male",
          _1: {
            ctor: "::",
        ...
        _1: {
          ctor: "::",
          _0: A3(
            _user$project$Main$selectDiv,
            _user$project$Main$onChangeUnit(function(units) {
              return _user$project$Main$UpdateBodyweightUnits(_user$project$Main$toUnits(units));
            }),
            "Bodyweight Units",
            {
              ctor: "::",
          ...
          _1: {
            ...
            _0: A3(
              _user$project$Main$selectDiv,
              _user$project$Main$onChangeUnit(function(units) {
                return _user$project$Main$UpdateWeightUnits(_user$project$Main$toUnits(units));
              }),
              "Weight Units",
              {
                ctor: "::",
            ...
            _1: {
              ...
              _0: A4(
                ...
                "text",
                _user$project$Main$UpdateBodyweight,
                "Body Weight",
                model.partialBodyweight
              ),
              _1: {
                ctor: "::",
                _0: A4(
                  ...
                  _0: A2(
                    ...
                    { ctor: "[]" },
                    {
                      ...
                      _0: A2(
                        ...
                        {
                          ctor: "::",
                          _0: _elm_lang$html$Html$text("Wilks Score"),
                          _1: { ctor: "[]" },
                        }
                      ),
                      _1: {
                        ctor: "::",
                        _0: _elm_lang$html$Html$text(textWilks),
                        _1: { ctor: "[]" },
                      },
                    }
                  ),
  ...
  var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram({
    model: _user$project$Main$initModel,
