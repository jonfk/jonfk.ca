...
Elm.Main.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var wilksCoeffWithCoeffs = F7(function (a,b,c,d,e,f,bodyweight) {
      var x = bodyweight;
      return 500 / (a + b * x + c * Math.pow(x,2) + d * Math.pow(x,3) + e * Math.pow(x,4) + f * Math.pow(x,5));
   });
   var femaleWilksCoeffKg = function (bodyweight) {
      var f = -9.054e-8;
      var e = 4.731582e-5;
      var d = -9.30733913e-3;
      var c = 0.82112226871;
      ...
      return A7(wilksCoeffWithCoeffs,a,b,c,d,e,f,bodyweight);
   };
   var maleWilksCoeffKg = function (bodyweight) {
      var f = -1.291e-8;
      var e = 7.01863e-6;
      var d = -1.13732e-3;
      var c = -2.388645e-3;
   ...
   var wilksCoeffKg = F2(function (gender,bodyweight) {
      var _p0 = gender;
      if (_p0.ctor === "Male") {
            return maleWilksCoeffKg(bodyweight);
         } else {
            return femaleWilksCoeffKg(bodyweight);
         }
   });
   var wilksScoreKg = F3(function (gender,bodyweight,weight) {    return A2(wilksCoeffKg,gender,bodyweight) * weight;});
   var fieldNameStyle = function (px) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: px}
                                            ,{ctor: "_Tuple2",_0: "padding",_1: "10px"}
                                            ,{ctor: "_Tuple2",_0: "text-align",_1: "right"}
                                            ,{ctor: "_Tuple2",_0: "display",_1: "inline-block"}]));
   };
   var stringToAction = F3(function (address,toAction,string) {
      var _p1 = $String.toFloat(string);
      if (_p1.ctor === "Ok") {
            var _p2 = _p1._0;
            return A2($String.endsWith,".",string) ? A2($Signal.message,address,A2(toAction,$Maybe.Just(_p2),string)) : A2($Signal.message,
            address,
            A2(toAction,$Maybe.Just(_p2),$Basics.toString(_p2)));
         } else {
            return A2($Signal.message,address,A2(toAction,$Maybe.Nothing,string));
         }
   });
   var onChangeUnit = F2(function (address,toAction) {
      return A3($Html$Events.on,"change",$Html$Events.targetValue,function (val) {    return A2($Signal.message,address,toAction(val));});
   });
   var removeSpace = $String.filter(function ($char) {    return !_U.eq($char,_U.chr(" "));});
   var selectDiv = F4(function (address,onChange,name,options) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([fieldNameStyle("160px")]),
              _U.list([A2($Html.label,_U.list([A2($Html$Attributes.attribute,"for",removeSpace(name))]),_U.list([$Html.text(name)]))]))
              ,A2($Html.select,
              _U.list([A2($Html$Attributes.attribute,"name",removeSpace(name)),onChange(address)]),
              A2($List.map,function (opt) {    return A2($Html.option,_U.list([]),_U.list([$Html.text(opt)]));},options))]));
   });
   var field = F5(function (fieldType,address,toAction,name,content) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([$Html$Attributes.type$(fieldType)
                      ...
                      ,A2($Html$Attributes.attribute,"name",removeSpace(name))
                      ,A3($Html$Events.on,"input",$Html$Events.targetValue,A2(stringToAction,address,toAction))]),
              _U.list([]))]));
   });
   var update = F2(function (action,model) {
      var _p3 = action;
      switch (_p3.ctor)
      {case "UpdateGender": return _U.update(model,{gender: _p3._0});
         case "UpdateBodyweightUnits": return _U.update(model,{bodyweightUnits: _p3._0});
         case "UpdateBodyweight": return _U.update(model,{bodyweight: _p3._0,partialBodyweight: _p3._1});
         case "UpdateWeightUnits": return _U.update(model,{weightUnits: _p3._0});
         case "UpdateWeight": return _U.update(model,{weight: _p3._0,partialWeight: _p3._1});
         default: return model;}
   });
   var NoOp = {ctor: "NoOp"};
   var UpdateWeight = F2(function (a,b) {    return {ctor: "UpdateWeight",_0: a,_1: b};});
   var UpdateWeightUnits = function (a) {    return {ctor: "UpdateWeightUnits",_0: a};};
   var UpdateBodyweight = F2(function (a,b) {    return {ctor: "UpdateBodyweight",_0: a,_1: b};});
   var UpdateBodyweightUnits = function (a) {    return {ctor: "UpdateBodyweightUnits",_0: a};};
   var UpdateGender = function (a) {    return {ctor: "UpdateGender",_0: a};};
   var Model = F7(function (a,b,c,d,e,f,g) {
      return {gender: a,partialBodyweight: b,bodyweightUnits: c,bodyweight: d,weightUnits: e,partialWeight: f,weight: g};
   });
   var Lbs = {ctor: "Lbs"};
   var Kg = {ctor: "Kg"};
   var toUnits = function (unit) {    var _p4 = unit;switch (_p4) {case "kg": return Kg;case "lbs": return Lbs;default: return Lbs;}};
   var Female = {ctor: "Female"};
   var Male = {ctor: "Male"};
   var toGender = function (gender) {    var _p5 = gender;switch (_p5) {case "Male": return Male;case "Female": return Female;default: return Female;}};
   var onChangeGender = function (address) {
      return A3($Html$Events.on,"change",$Html$Events.targetValue,function (val) {    return A2($Signal.message,address,UpdateGender(toGender(val)));});
   };
   var view = F2(function (address,model) {
      var toKg = function (x) {    return x * 0.453592;};
      var bodyweight = _U.eq(model.bodyweightUnits,Kg) ? model.bodyweight : A2($Maybe.map,toKg,model.bodyweight);
      var weight = _U.eq(model.weightUnits,Kg) ? model.weight : A2($Maybe.map,toKg,model.weight);
      var maybeWilks = A3($Maybe.map2,wilksScoreKg(model.gender),bodyweight,weight);
      var textWilks = A2($Maybe.withDefault,"",A2($Maybe.map,$Basics.toString,maybeWilks));
      return A2($Html.div,
      _U.list([]),
      _U.list([A4(selectDiv,address,onChangeGender,"Gender",_U.list(["Male","Female"]))
              ,A4(selectDiv,
              address,
              function (v) {
                 return A2(onChangeUnit,v,function (units) {    return UpdateBodyweightUnits(toUnits(units));});
              },
              "Bodyweight Units",
              _U.list(["lbs","kg"]))
              ,A4(selectDiv,
              address,
              function (v) {
                 return A2(onChangeUnit,v,function (units) {    return UpdateWeightUnits(toUnits(units));});
              },
              "Weight Units",
              _U.list(["lbs","kg"]))
              ,A5(field,"text",address,UpdateBodyweight,"Body Weight",model.partialBodyweight)
              ,A5(field,"text",address,UpdateWeight,"Weight",model.partialWeight)
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.div,_U.list([fieldNameStyle("160px")]),_U.list([$Html.text("Wilks Score")])),$Html.text(textWilks)]))]));
   });
   var initModel = {gender: Male
                   ,bodyweightUnits: Lbs
                   ,partialBodyweight: ""
                   ,bodyweight: $Maybe.Nothing
                   ,weightUnits: Lbs
                   ,partialWeight: ""
                   ,weight: $Maybe.Nothing};
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,UpdateBodyweightUnits: UpdateBodyweightUnits
                             ,UpdateBodyweight: UpdateBodyweight
                             ,UpdateWeightUnits: UpdateWeightUnits
                             ...
                             ,wilksScoreKg: wilksScoreKg
                             ,wilksCoeffKg: wilksCoeffKg
                             ,maleWilksCoeffKg: maleWilksCoeffKg
                             ,femaleWilksCoeffKg: femaleWilksCoeffKg
                             ,wilksCoeffWithCoeffs: wilksCoeffWithCoeffs
                             ,main: main};
};
